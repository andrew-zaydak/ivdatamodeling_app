...
def make_brand(**kwargs):
    ...
    #hildren=html.H1([html.Img(src='/assets/blue_tall.png', height='101', width='141'), server.config["TITLE"]]),
    return html.Header(
        className="brand",
        
        children=dcc.Link(
            href=get_url(""),
            children=html.H1([html.Img(src='/assets/blue_tall.png', height='101', width='141')]),
        ),
        **kwargs,
    )
